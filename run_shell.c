...
/**
 * run_shell - this function runs the simple shell program
 * @my_argv: input strings
 * @my_envp: input environment variables
 * @search_path: pointer to pointer search path
 * @tmp: temp string
 * Return: void
 */
